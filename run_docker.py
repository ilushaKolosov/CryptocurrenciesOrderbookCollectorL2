...
async def main():
    ...
    try:
        ...
        from feature_calculator import OptimizedFeatureCalculator
        ...
        logger.info("🧮 Инициализация ОПТИМИЗИРОВАННОГО калькулятора фичей...")
        calculator = OptimizedFeatureCalculator()
        logger.info("✅ Оптимизированный калькулятор фичей создан")
        
        # Запускаем оба процесса параллельно
        logger.info("🔄 Запуск сбора данных и вычисления ОПТИМИЗИРОВАННЫХ фичей...")
